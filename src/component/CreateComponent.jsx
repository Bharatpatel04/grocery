  ...
  return (
    <div className="w-full h-auto min-h-screen flex items-center justify-center">
      <div className="w-[90%] md:w[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
        ...
        <div className="group flex items-center justify-center flex-col border-2 border-dotted border-gray-300 w-full h-225 md:h-420 ">
          {isLoading ? (
            <Loader />
          ) : (
            <>
        ...
        <div className=" w-full flex flex-col md:flex-row items-center gap-3">
          ...
          <div className=" w-full py-2 border-b border-gray-300 flex items-center gap-2">
            <HiCurrencyRupee className=" text-gray-700 text-2xl " />
            <input
              type="text"
              required
              value={price}
